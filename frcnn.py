...
class FRCNN(object):
    _defaults = {
        "model_path": '/content/drive/My Drive/app/faster-rcnn-tf2-main/logs/epoch010-loss1.728-rpn1.082-roi0.646.h5',
        "classes_path": '/content/drive/My Drive/app/faster-rcnn-tf2-main/model_data/voc_classes.txt',
        "confidence": 0.7,
    }
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font='/content/drive/My Drive/app/faster-rcnn-tf2-main/model_data/simhei.ttf',size=np.floor(3e-2 * np.shape(image)[1] + 0.5).astype('int32'))
